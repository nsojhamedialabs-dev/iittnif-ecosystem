...
export default function Page() {
  return (
    <>
      <a href="/technology-labs" className="text-small text-neutral-text-secondary underline">← Technology & Labs</a>
      <Hero title="Collaborations" subtitle="Our research and deployment partnerships." stage="mandate" />
    </>
  )
}
